...
interface Scene9FutureVisionProps extends SceneProps {
  userChoices?: any;
  storeUserChoice?: (key: string, value: any) => void;
}

const Scene9_FutureVision: React.FC<Scene9FutureVisionProps> = ({
  onNext,
  isActive
}) => {
  ...
  return (
    <ScrollableScene showScrollIndicator={false}>
      <div className="relative min-h-screen w-full flex items-center justify-center py-12 sm:py-16">
...
export default Scene9_FutureVision;